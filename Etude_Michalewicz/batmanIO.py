...
class batmanIO:
    ...
    def read(self):
        ...
        for i in range(nbDir):
            self.__F.append(np.load(path+'output/predictions/Newsnap'+str(i)+'/sample-data.npy'))
            # with np.load(path+'output/predictions/Newsnap'+str(i)+'/sample-space.npy') as data:
            #     print("data",data)
