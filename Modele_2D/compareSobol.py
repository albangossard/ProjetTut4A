...
for gamme in list_gamme:
    ...
    for choice in list_choice:
        if gamme==-1:
            fileName='sensAnalysis/sensAnalysis_'+distribName+global_compare+'_choice='+str(choice)+'/uq'+method+'/sensitivity.json'
        else:
            fileName='sensAnalysis/sensAnalysis_'+distribName+global_compare+'_gamme='+str(gamme)+'_choice='+str(choice)+'/uq'+method+'/sensitivity.json'
