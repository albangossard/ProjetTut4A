...
for choice in list_choice:
    if gamme==-1:
        ...
        list_h_pred_krig = np.loadtxt('LOO_list_h_pred_krig_gamme='+str(id_gamme)+'_choice='+str(choice)+'.txt')
        list_h_val_krig = np.loadtxt('LOO_list_h_val_krig_gamme='+str(id_gamme)+'_choice='+str(choice)+'.txt')
