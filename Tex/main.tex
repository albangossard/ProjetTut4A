...
\\
\\
(1)Also, $\hat{Y}$ admits the perfect values at the $Y_i$ measures.
\\
\\
...
$$ (\lambda_1,\ldots,\lambda_n)=argmin_{\sum \lambda_i=1 } Var(\hat{Y}_0-Y_0)$$
